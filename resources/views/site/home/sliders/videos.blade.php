<div id="videos_slider">
    ...
    <div class="owl-carousel">
        <div class="item">
            <a href="#">
                <div class="image mb-2" style="background-image: url(https://mir-s3-cdn-cf.behance.net/project_modules/disp/c0b56695918705.5ea268f33ef67.png);">
        ...
        <div class="item">
            <a href="#">
                <div class="image mb-2" style="background-image: url(https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/e79d2032224139.56748c06a642b.jpg);">
                    <i class="fa fa-play" aria-hidden="true"></i>
                </div>
        ...
        <div class="item">
            <a href="#">
                <div class="image mb-2" style="background-image: url(https://mir-s3-cdn-cf.behance.net/project_modules/disp/b6d87195918705.5ea268f340caa.png);">
                    <i class="fa fa-play" aria-hidden="true"></i>
                </div>
                <h6 class="title mb-2">Туысы бiрдiн уысы бiр</h6>
                <div class="info mb-2">
        ...
        <div class="item">
            <a href="#">
                <div class="image mb-2" style="background-image: url(https://mir-s3-cdn-cf.behance.net/project_modules/disp/5bd7b895918705.5ea268f33e814.png);">
                    <i class="fa fa-play" aria-hidden="true"></i>
                </div>
                <h6 class="title mb-2">Туысы бiрдiн уысы бiр</h6>
                <div class="info mb-2">
